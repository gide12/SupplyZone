...
const filePath = path.join(process.cwd(), 'src/components/SupplierInventory.tsx');
let content = fs.readFileSync(filePath, 'utf8');

if (!content.includes('WeatherForecastModal')) {
  // Imports
  ...
  console.log("Updated SupplierInventory.tsx");
}
